...
import pl.wb.demo.chess.model.board.Move.RevertMoveIfIncorrect;
...
public class CastlingRookMovesValidation {
    ...
    public CastlingRookMovesValidation(Board board, PossibleActions possibleActions, Position piecePositionNEW){
        this.board = board;
    ...
    public Piece rookMoveWhenCastling () {
        ...
        if (this.possibleActions.getKingCastlingActions().contains(piecePositionNEW)) {
            ...
            } else moveBack.revertNewMove(piecePositionNEW);
            ...
            moveBack.revertNewMove(piecePositionNEW);
            return null;
        }return null;
    }
}
