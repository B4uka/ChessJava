...
import com.wb.demo.chess.model.ChessGame;
    ...
    public PossibleActions generatePossibleActions (Board board) {
        ...
        if (this.color == Color.BLACK && !ChessGame.blackCastled && board.getBlackKingPiece().getCountMoves() == 0) {
            ...
            if (!ChessGame.isBlackKingChecked() && !board.isBoardOccupiedByAnyPiece(0, 5) && board.getPiece(0, 7).getCountMoves() == 0
                    && !board.isBoardOccupiedByAnyPiece(0, 6) && board.getBlackPiece(0, 7).getClass() == Rook.class) {
            ...
            if (!ChessGame.isBlackKingChecked() && !board.isBoardOccupiedByAnyPiece(0, 3) && board.getPiece(0, 0).getCountMoves() == 0
                    && !board.isBoardOccupiedByAnyPiece(0, 2) && !board.isBoardOccupiedByAnyPiece(0, 1) && board.getBlackPiece(0, 0).getClass() == Rook.class) {
            ...
            if (!ChessGame.isWhiteKingChecked() && !board.isBoardOccupiedByAnyPiece(7, 5) && board.getPiece(7, 7).getCountMoves() == 0
                    && !board.isBoardOccupiedByAnyPiece(7, 6) && board.getWhitePiece(7, 7).getClass() == Rook.class) {
                possibleActions.addPossibleCastlingKingMove(castlingKingMove[0]);//King move
            }
            if (!ChessGame.isWhiteKingChecked() && !board.isBoardOccupiedByAnyPiece(7, 3) && board.getPiece(7, 0).getCountMoves() == 0
                    && !board.isBoardOccupiedByAnyPiece(7, 2) && !board.isBoardOccupiedByAnyPiece(7, 1) && board.getWhitePiece(7, 0).getClass() == Rook.class) {
                possibleActions.addPossibleCastlingKingMove(castlingKingMove[1]);//King move
            }
        }
