    ...
    public PossibleActions generatePossibleActions (Board board) {
        ...
        outloop:
        {
            for (int i = 1; i < 8; i++) {
                if (!rookMove[0].isOnBoard() || (this.color == Color.BLACK && board.isOccupiedByColor(rookMove[0], Color.BLACK)) || (this.color == Color.WHITE && board.isOccupiedByColor(rookMove[0], Color.WHITE))) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(rookMove[0], Color.BLACK, King.class)) {
                    ...
                    break;
                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(rookMove[0], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(rookMove[0]);
                    break outloop;
            ...
            for (int i = 1; i < 8; i++) {
                if (!rookMove[1].isOnBoard() || (this.color == Color.BLACK && board.isOccupiedByColor(rookMove[1], Color.BLACK)) || (this.color == Color.WHITE && board.isOccupiedByColor(rookMove[1], Color.WHITE))) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(rookMove[1], Color.BLACK, King.class)) {
                    ...
                    break;
                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(rookMove[1], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(rookMove[1]);
                    break outloop;
            ...
            for (int i = 1; i < 8; i++) {
                if (!rookMove[2].isOnBoard() || (this.color == Color.BLACK && board.isOccupiedByColor(rookMove[2], Color.BLACK)) || (this.color == Color.WHITE && board.isOccupiedByColor(rookMove[2], Color.WHITE))) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(rookMove[2], Color.BLACK, King.class)) {
                    ...
                    break;
                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(rookMove[2], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(rookMove[2]);
                    break outloop;
            ...
            for (int i = 1; i < 8; i++) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(rookMove[3], Color.BLACK, King.class)) {
                    possibleActions.addPossibleChecks(rookMove[3]);
                    break outloop;
                } else if (this.color == Color.WHITE && board.isOccupiedByColor(rookMove[3], Color.BLACK) && !board.isOccupiedBySpecificPiece(rookMove[3], color, King.class)) {
                    possibleActions.addPossibleCapture(rookMove[3]);
                    break;

                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(rookMove[3], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(rookMove[3]);
                    break outloop;
                } else if (this.color == Color.BLACK && board.isOccupiedByColor(rookMove[3], Color.WHITE) && !board.isOccupiedBySpecificPiece(rookMove[3], color, King.class)) {
                    possibleActions.addPossibleCapture(rookMove[3]);
                    break;
                }
