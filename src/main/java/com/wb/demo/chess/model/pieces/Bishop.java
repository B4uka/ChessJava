    ...
    public PossibleActions generatePossibleActions (Board board) {
        ...
        outloop:
        {
            for (int i = 1; i < 8; i++) {
                if (!bishopMove[0].isOnBoard() || (this.color == Color.BLACK && board.isOccupiedByColor(bishopMove[0], Color.BLACK)) || (this.color == Color.WHITE && board.isOccupiedByColor(bishopMove[0], Color.WHITE))) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(bishopMove[0], Color.BLACK, King.class)) {
                    ...
                    break;
                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(bishopMove[0], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(bishopMove[0]);
                    break outloop;
            ...
            for (int i = 1; i < 8; i++) {
                if (!bishopMove[1].isOnBoard() || (this.color == Color.BLACK && board.isOccupiedByColor(bishopMove[1], Color.BLACK)) || (this.color == Color.WHITE && board.isOccupiedByColor(bishopMove[1], Color.WHITE))) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(bishopMove[1], Color.BLACK, King.class)) {
                    ...
                    break;
                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(bishopMove[1], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(bishopMove[1]);
                    break outloop;
            ...
            for (int i = 1; i < 8; i++) {
                if (!bishopMove[2].isOnBoard() || (this.color == Color.BLACK && board.isOccupiedByColor(bishopMove[2], Color.BLACK)) || (this.color == Color.WHITE && board.isOccupiedByColor(bishopMove[2], Color.WHITE))) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(bishopMove[2], Color.BLACK, King.class)) {
                    ...
                    break;
                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(bishopMove[2], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(bishopMove[2]);
                    break outloop;
            ...
            for (int i = 1; i < 8; i++) {
                if (!bishopMove[3].isOnBoard() || (this.color == Color.BLACK && board.isOccupiedByColor(bishopMove[3], Color.BLACK)) || (this.color == Color.WHITE && board.isOccupiedByColor(bishopMove[3], Color.WHITE))) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(bishopMove[3], Color.BLACK, King.class)) {
                    ...
                    break;
                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(bishopMove[3], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(bishopMove[3]);
                    break outloop;
