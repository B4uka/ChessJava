    ...
    public PossibleActions generatePossibleActions (Board board) {
        ...
        outloop:
        {
            for (int i = 1; i < 8; i++) {
                if (!queenMove[0].isOnBoard() || (this.color == Color.BLACK && board.isOccupiedByColor(queenMove[0], Color.BLACK)) || (this.color == Color.WHITE && board.isOccupiedByColor(queenMove[0], Color.WHITE))) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(queenMove[0], Color.BLACK, King.class)) {
                    ...
                    break;
                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(queenMove[0], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(queenMove[0]);
                    break outloop;
            ...
            for (int i = 1; i < 8; i++) {
                if (!queenMove[1].isOnBoard() || (this.color == Color.BLACK && board.isOccupiedByColor(queenMove[1], Color.BLACK)) || (this.color == Color.WHITE && board.isOccupiedByColor(queenMove[1], Color.WHITE))) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(queenMove[1], Color.BLACK, King.class)) {
                    ...
                    break;
                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(queenMove[1], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(queenMove[1]);
                    break outloop;
            ...
            for (int i = 1; i < 8; i++) {
                if (!queenMove[2].isOnBoard() || (this.color == Color.BLACK && board.isOccupiedByColor(queenMove[2], Color.BLACK)) || (this.color == Color.WHITE && board.isOccupiedByColor(queenMove[2], Color.WHITE))) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(queenMove[2], Color.BLACK, King.class)) {
                    ...
                    break;
                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(queenMove[2], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(queenMove[2]);
                    break outloop;
            ...
            for (int i = 1; i < 8; i++) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(queenMove[3], Color.BLACK, King.class)) {
                ...
                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(queenMove[3], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(queenMove[3]);
                    break outloop;
            ...
            for (int i = 1; i < 8; i++) {
                if (!queenMove[4].isOnBoard() || (this.color == Color.BLACK && board.isOccupiedByColor(queenMove[4], Color.BLACK)) || (this.color == Color.WHITE && board.isOccupiedByColor(queenMove[4], Color.WHITE))) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(queenMove[4], Color.BLACK, King.class)) {
                    ...
                    break;
                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(queenMove[4], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(queenMove[4]);
                    break outloop;
            ...
            for (int i = 1; i < 8; i++) {
                if (!queenMove[5].isOnBoard() || (this.color == Color.BLACK && board.isOccupiedByColor(queenMove[5], Color.BLACK)) || (this.color == Color.WHITE && board.isOccupiedByColor(queenMove[5], Color.WHITE))) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(queenMove[5], Color.BLACK, King.class)) {
                    ...
                    break;
                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(queenMove[5], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(queenMove[5]);
                    break outloop;
            ...
            for (int i = 1; i < 8; i++) {
                ...
                if (!board.isOccupied(queenMove[6])) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(queenMove[6], Color.BLACK, King.class)) {
                    ...
                    break;
                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(queenMove[6], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(queenMove[6]);
                    break outloop;
            ...
            for (int i = 1; i < 8; i++) {
                if (!queenMove[7].isOnBoard() || (this.color == Color.BLACK && board.isOccupiedByColor(queenMove[7], Color.BLACK)) || (this.color == Color.WHITE && board.isOccupiedByColor(queenMove[7], Color.WHITE))) {
                ...
                } else if (this.color == Color.WHITE && board.isOccupiedBySpecificPiece(queenMove[7], Color.BLACK, King.class)) {
                    ...
                    break;
                } else if (this.color == Color.BLACK && board.isOccupiedBySpecificPiece(queenMove[7], Color.WHITE, King.class)) {
                    possibleActions.addPossibleChecks(queenMove[7]);
                    break outloop;
