...
public class Board {
    ...
    private void fillBoardWithPieces () {
        ...
        this.boardOfPieces[2][2] = new King(new Position(2, 2), Color.WHITE);

//        this.boardOfPieces[7][3] = new Queen(new Position(7, 3), Color.BLACK);
        this.boardOfPieces[2][1] = new Queen(new Position(2, 1), Color.WHITE);

//        this.boardOfPieces[6][3] = new Queen(new Position(6, 3), Color.WHITE);
//
